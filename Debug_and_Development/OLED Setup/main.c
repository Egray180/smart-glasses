...
// ---------------- Pin mapping ----------------
#define OLED_SCL_BIT   BIT4   // P3.4
#define OLED_SDA_BIT   BIT5   // P3.5
#define OLED_RES_BIT   BIT6   // P3.6

#define OLED_PORT_DIR  P3DIR
#define OLED_PORT_OUT  P3OUT
#define OLED_PORT_IN   P3IN
#define OLED_PORT_REN  P3REN

// You have external 10k pull-ups already
...
// 0 = assume external VCC and pause so you can switch VCC on manually
#define USE_CHARGE_PUMP 1
